...
export default FavoriteListComponent = ({ favoriteCurrencies, selectedCurrency, BTCPrice, setFavoriteCurrencies }) => {
    ...
    return (
        <View>
            ...
            <FlatList
                ...
                renderItem={({ item }) => <FavItem selectedCurrency={item} setFavoriteCurrencies={setFavoriteCurrencies} />}
                keyExtractor={(item, index) => { item.currency_name + '-' + index }}
            />
        </View>
    )
}